...
sellingPrice.addEventListener('input', () => {
    let discount = ((actualPrice.value - sellingPrice.value ) / sellingPrice.value) ;
    discountPercentage.value = discount.toFixed(1) * 100;
})
...
const productData = () => {
    ...
    tagArr.forEach((item, i) => tagArr[i] = tagArr[i].trim().toLowerCase());
    return data = {
